...
class Reproductor():#Clase reproductor taller 2 Spotify
from datetime import datetime
...
class Reproductor():
    ...
    def reproducir_cancion(self, cancion):
        ...
        print(f'Se esta reproduciendo la cancion {cancion.titulo}')
    ...
    def siguiente_cancion(self):
        ...
        """
        Reproductor.indice += 1
        if Reproductor.indice < len(self.cola):
            self.reproducir_cancion(self.cola[Reproductor.indice])
        else:
            print("No hay mas canciones en cola")
            Reproductor.indice -=1 
